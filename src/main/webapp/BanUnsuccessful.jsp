   ...
   <div class="row">
      <div class="col-md-6 mx-auto mt-5">
         <div class="payment">
            ...
            <div class="content">
               <h1>Banning of Reader Failed!!</h1>
               <p style="color:purple;">Invalid User ID or Reader is Not Supposed to be Banned!!</p>
              <a href="/LibraryManagementSystemWebApplication/StaffMenu.jsp">Go to Menu</a>
            </div>
