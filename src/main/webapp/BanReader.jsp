...
<c:if test="${bannedReaderList.size() == 0}">
<div class="container">
<div class="row">
...
<br><button class="btn btn-success" onclick="window.location.href='StaffMenu.jsp';">Back</button>	
	<h3 align="center">Readers To Be Banned</h3>
<br>
...
<form action="BanReaderList" method="post">
...
<tbody>
<c:forEach var="bannedReaderList" items="${bannedReaderList}">
<tr>


	<td><c:out value="${bannedReaderList.id}" /></td>
	<td><c:out value="${bannedReaderList.first_name}" /></td>
