   ...
   <div class="row">
      <div class="col-md-6 mx-auto mt-5">
         <div class="payment">
            ...
            <div class="content">
               <h1>Publisher Deletion Failed!!</h1><br>
               <p style="color:purple;">Invalid User ID or Publisher is Not Supposed to be deleted!!</p>
               <a href="/LibraryManagementSystemWebApplication/DeletePublisherServlet">Try Again</a><br><br>
